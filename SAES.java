...
public class SAES {
	...
	public String encrypt(String plainText) {
		...
		// Round 1 - Nibble Substitution -> Shift Row -> Mix Columns -> Add Round Key
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter 16-bit plain text: ");
		msg = sc.next();

		SAES obj = new SAES(key);
		System.out.println(obj.getKeys());

		System.out.println("\n***** ENCRYPTION *****");
		String encryptedMsg = obj.encrypt(msg);
		System.out.println("Encrypted Message: "+encryptedMsg);

		System.out.println("\n***** DECRYPTION *****");
		String decryptedMsg = obj.decrypt(encryptedMsg);
